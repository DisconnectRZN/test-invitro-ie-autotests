...
// Авторизация
    ...
    public void enterLoginFieldAuthorization() { // Ввод Имени

        help.Enter_Text(LoginFieldAuthorization, "pacient.lk1.invitro.desctop@yandex.ru");
    }

    public void enterPasswordFieldAuthorization() { // Ввод Имени
...
// Создание мед карты
    ...
    public void clickChooseMedCart() { //Кликнуть, Выбрать мед карту
        ...
        help.Click_Method(ChooseMedCart);
    }
...
// Методы оформления заказа с новой мед карты
    ...
    */
    ...
    public void enterSearchInzPacientField() { // Ввод ИНЗ
        ...
        help.Enter_Text(SearchInzPacientField, "LK000313882");
    }
