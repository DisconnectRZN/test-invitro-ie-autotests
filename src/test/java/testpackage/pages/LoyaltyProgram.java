...
public class LoyaltyProgram extends PageObject {
    ...
    private By OpenMainMenu = By.xpath("//button[@class='header-menu__btn ripple']");// Открытие меню бургер
    private By LoyaltyProgramLink = By.xpath("//*[@class='header-menu__link header-menu__link--title'][contains(text(),'Программа «ИНВИТРО Здоровый плюс»')]"); // Ссылка на Программу лояльности
    private By HeaderLoyaltyProgram  = By.xpath("//div[contains(@class,'title-block')]"); // Заголовок Программа лояльности ИНВИТРО
    private By BannerLoyaltyProgram = By.xpath("//*[@class='service-home-banner__image']"); // Баннер на странице Программы лояльности
    private By TitleBonusesOrDiscounts = By.xpath("//div[@class='service-home-about']"); // Блок рядом с баннером

    private By BannerText = By.xpath("//*[contains(text(),' - это компл')]"); // Текст «ИНВИТРО Здоровый плюс» - это комплексная программа поощрения
    private By BannerText2 = By.xpath("//*[contains(text(),'«ИНВИТРО Здоровый плюс» – это')]"); // Текст Вы сами решаете, что Вам удобнее: скидки или бонусы
    private By Attention128LoyaltyProgram = By.xpath("//div[@class = 'loyalty__attention-title']"); //Блок Внимание
    private By SimultaneousLoyaltyProgram = By.xpath("//div[@class = 'loyalty__attention-text']"); //Блок текста Одновременное участие в двух программах
    private By Rules1LoyaltyProgram = By.xpath("//div[@class = 'loyalty__attention']/a"); // 1 Полные правила программы

    //--------------------География программы

    private By HeadingGeography = By.xpath("//*[@class='investors__map-block-title']"); // Заголовок География программы лояльности
    private By GeographyTextLoyalityProgram = By.xpath("//*[contains(text(),'Программа «ИНВИТРО Здоровый плюс» дей')]"); // Текст в блоке география программы
    private By BannerGeography = By.xpath("//*[@class='loyalty__planet']"); // Баннер Географии программы лояльности

    private By HeaderBonusProgram = By.xpath("//span[contains(text(),'Бонусная программа «ИНВИТРО')]"); //Заголовок Бонусная программа «ИНВИТРО Здоровый плюс»
    private By HeaderDiscountProgram = By.xpath("//span[contains(text(),'Дисконтная программа «ИНВИТРО')]"); //Заголовок Дисконтная программа «ИНВИТРО Здоровый плюс»
    private By BonusProgram1 = By.xpath("//*[contains(text(),'Это накопительная про')]"); // Текст Бонусная программа
    private By DiscountProgram = By.xpath("//*[contains(text(),'Это программ')]"); // Текст Дисконтная программа
    private By Rules2LoyaltyProgram = By.xpath("//div[@class='service-home-answer']//div[@class = 'result-item__tags']/a"); // 2 Полные правила программы

    //--------Преимущества бонусной программы

    private By HeadingBP = By.xpath("//h2[contains(text(),'Бонусная программа')]"); // Заголовок Бонусная программа
    private By BenefitsBP = By.xpath("//*[contains(text(),'Преимущества бонусной программы')]"); // Преимущества бонусной программы
    private By Text123BP = By.xpath("//*[contains(text(),'Участвуйте в бонусной')]"); // Текст Участвуйте в бонусной программе и оплачивайте заказы

    //--------Иконки
    private By Label01BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[1]/img"); // 1-ая иконка ББ
    private By Label02BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[2]/img"); // 2-ая иконка ББ
    private By Label03BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[3]/img"); // 3-я иконка ББ
    private By Label04BP = By.xpath("//*[contains(@class,'show-block--active')][2]/div[1]/img"); // 4-ая иконка ББ
    private By Label05BP = By.xpath("//*[contains(@class,'show-block--active')][2]/div[2]/img"); // 5-ая иконка ББ

    //--------------Текст под иконками
    private By Text01BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[1]/div/p"); // 1-ый текст ББ
    private By Text02BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[2]/div/p"); // 2-ой текст ББ
    private By Text03BP = By.xpath("//*[contains(@class,'show-block--active')][1]/div[3]/div/p"); // 3-ий текст ББ
    private By Text04BP = By.xpath("//*[contains(@class,'show-block--active')][2]/div[1]/div/p"); // 4-ый текст ББ
    private By Text05BP = By.xpath("//*[contains(@class,'show-block--active')][2]/div[2]/div/p"); // 5-ый текст ББ

    //-------Как стать участником бонусной программы
    private By HeaderAsBPLoyalityProgram = By.xpath("//h2[contains(text(),'Как стать участником бонусной')]"); // заголовок Как стать участником бонусной программы?
    private By TextBPLoyalityProgram = By.xpath("//div[contains(text(),'чтобы стать участником бонусной ')]"); // Текст Для того, чтобы стать участником бонусной программы «ИНВИТРО Здоровый плюс» необходимо:
    private By Text2BPLoyalityProgram = By.xpath("//div[contains(@class,'directions show-block directions--three directions--jcfs show-block--active')]/div[1]/span[2]"); // Текст Оформить и оплатить заказ в ИНВИТРО
    private By Text3BPLoyalityProgram = By.xpath("//div[contains(@class,'directions show-block directions--three directions--jcfs show-block--active')]/div[2]/span[2]"); // Текст Подписать согласие на участие в программе

    //------Статусы участников бонусной программы
    private By HeadingStatus = By.xpath("//*[contains(text(),'участников бонусной программы')]"); // Заголовок Статусы участников
    private By Label5BP = By.xpath("//div[contains(text(),'5%')]"); // Иконка 5% БП
    private By Label7BP = By.xpath("//div[contains(text(),'7%')]"); // Иконка 7% БП
    private By LabelTest10BP = By.xpath("//*[@class='features__item-icon'][contains(text(),'10%')]"); // Иконка 10% БП
    private By Label30BP1 = By.xpath("//div[contains(text(),'30%')]"); // Иконка 30% БП
    private By TextBPStandart = By.xpath("//*[contains(text(),'«Стандарт»')]"); // Текст Статус участника «Стандарт»
    private By TextBPSilver = By.xpath("//*[contains(text(),'«Серебряный»')]"); // Текст Статус участника «Серебряный»
    private By TextBPGolden = By.xpath("//*[contains(text(),'«Золотой»')]"); // Текст Статус участника «Золотой»
    private By TextBPSocial = By.xpath("//*[contains(text(),'участника «Социальный»')]"); // Текст Статус участника «Социальный»
    private By TextBPVeteran = By.xpath("//*[contains(text(),'участника «Ветеран»')]"); // Текст Статус участника «Ветеран»
    private By TextBPStandart999 = By.xpath("//*[contains(text(),' 9 999 рублей.')]"); // Текст Общая сумма 9999
    private By TextBPSilver1999 = By.xpath("//*[contains(text(),'19 999 рублей.')]"); // Текст Общая сумма 19999
    private By TextBPGolden20000 = By.xpath("//*[contains(text(),'20 000 рублей.')]"); // Текст Общая сумма 20000
    private By TextBPSocialSoc = By.xpath("//*[contains(text(),'Предоставляется')]"); // Текст Предоставляется гражданам следующих категорий: пенсионеры, инвалиды I
    private By TextBPVeteranVet = By.xpath("//*[contains(text(),'Граждане')]"); // Текст Граждане, являющиеся ветеранами ВОВ, ветеранами локальных войн,

    //--------Как копить?
    private By HeadingHow = By.xpath("//*[contains(text(),'Как копить?')]"); // Заголовок Как копить?
    private By LabelBB = By.xpath("//*[@src='/local/templates/invitro_main/src/image/icons/save.svg']"); // Иконка Бонусные баллы
    private By LabelHiB = By.xpath("//*[@src='/local/templates/invitro_main/src/image/icons/save-200.svg']"); // Иконка Приветственный бонус
    private By LabelBirthday = By.xpath("//*[@src='/local/templates/invitro_main/src/image/icons/save-500.svg']"); // Иконка Бонусы в день рождения
    private By LabelAdditional1 = By.xpath("//*[@src='/local/templates/invitro_main/src/image/icons/save-plus.svg']"); // Иконка Дополнительные бонусы
    private By TextBonusBalls = By.xpath("//*[contains(@class,'service-home__title')][contains(text(),'Бонусные баллы')]"); // Текст Бонусные баллы
    private By TextWelcomeBonus = By.xpath("//*[contains(text(),'Приветственный бонус')]"); // Текст Приветственный бонус
    private By TextBirthdayBonuses1 = By.xpath("//*[contains(text(),'Бонусы в день рождения')]"); // Текст Бонусы в день рождения
    private By TextAdditionalBonuses = By.xpath("//span[contains(text(),'Дополнительные бонусы')]"); // Текст Дополнительные бонусы

    private By TextBonusBallsAccrue = By.xpath("//p[contains(text(),'Бонусные баллы')]"); // Текст Бонусные баллы начисляются согласно статусу участника
    private By TextBonusBallsEverybody = By.xpath("//*[contains(text(),'Всем пациентам')]"); // Текст Всем пациентам, заказавшим услуги
    private By TextBirthdayBonuses500 = By.xpath("//*[contains(text(),'Всем участникам')]"); // Текст Всем участникам программы в день рождения ИНВИТРО дарит 500 бонусов
    private By TextAdditionalBonuses1 = By.xpath("//*[contains(text(),'Бонусы, начисляемые')]"); // Текст Бонусы, начисляемые в зависимости от суммы заказа:
    private By TextAdditionalBonuses2 = By.xpath("//li[contains(text(),'При единовременной покупке услуг')][1]"); // Блок При единовременной покупке услуг на сумму свыше 10 000 рублей – дополнительно 400 бонусов;
    private By TextAdditionalBonuses3 = By.xpath("//li[contains(text(),'При единовременной покупке услуг')][2]"); // Блок При единовременной покупке услуг на сумму свыше 20 000 рублей – дополнительно 1 000 бонусов.

    //-------Как использовать бонусные баллы?
    private By Whoisp = By.xpath("//*[@class='service-home-row use_bonus']"); // Блок Как использовать бонусные баллы?
    private By HeadingHowToUse = By.xpath("//h2[contains(text(),'Как использовать')]"); // Заголовок Как использовать бонусные баллы?
    private By Text1HowToUse = By.xpath("//li[contains(text(),'Накопленными бонусами можно оплатить')]"); // Текст 1. Накопленными бонусами можно оплатить до 50% от суммы заказа из расчета 1 бонус = 1 рубль, но не более 30 000 бонусов за заказ;
    private By Text2HowToUse = By.xpath("//li[contains(text(),'Бонусные баллы доступны к списанию')]"); // Текст 2. Бонусные баллы доступны к списанию через 24 часа после их начисления;
    private By Text3HowToUse = By.xpath("//li[contains(text(),'Бонусы, начисленные первыми')]"); // Текст 3. Бонусы, начисленные первыми, списываются в первую очередь;
    private By Text4HowToUse = By.xpath("//li[contains(text(),'Лимит по 1 карте')]"); // Текст 4. Лимит по 1 карте за 1 день - 3 заказа на медицинские услуги.

    //------Срок действия бонусных баллов
    private By SrokDeistv = By.xpath("//*[@class='service-home-row'][3]"); // Блок Срок действия бонусных баллов
    private By HeadingSrokDeistv = By.xpath("//h2[contains(text(),'Срок действия бонусных ')]"); // Заголовок Срок действия бонусных баллов;
    private By Text1SrokDeistv = By.xpath("//li[contains(text(),'Приветственные бонусы')]"); // Текст 1. Приветственные бонусы – срок действия 1 год;
    private By Text2SrokDeistv = By.xpath("//li[contains(text(),'Бонусные баллы согласно')]"); // Текст 2. Бонусные баллы доступны к списанию через 24 часа после их начисления;
    private By Text3SrokDeistv = By.xpath("//li[contains(text(),'Дополнительные бонусы')]"); // Текст 3. Бонусы, начисленные первыми, списываются в первую очередь;
    private By Text4SrokDeistv = By.xpath("//li[contains(text(),'Подарочные бонусы')]"); // Текст 4. Лимит по 1 карте за 1 день - 3 заказа на медицинские услуги.

    //----Переход на дисконтную программу
    private By HeadingTransition = By.xpath("//*[contains(text(),'Переход на дисконтную программу')]"); // Заголовок Переход на дисконтную программу
    private By LabelDisconnectBP = By.xpath("//*[@src='/local/templates/invitro_main/src/image/content/directions/loyalty-1.svg']"); // Иконка Отключиться от бонусной программы
    private By LabelToWrite = By.xpath("//*[@src='/local/templates/invitro_main/src/image/content/directions/loyalty-2.svg']"); // Иконка Написать заявление
    private By LabelReceive = By.xpath("//*[@src='/local/templates/invitro_main/src/image/content/directions/loyalty-3.svg']"); // Иконка Получить ДК
    private By TextDisconnectBP = By.xpath("//*[contains(text(),'Отключиться от бонусной')]"); // Текст Отключиться от бонусной программы в любом медицинском офисе, подписав отказ от участия в бонусной программе
    private By TextToWrite = By.xpath("//*[contains(text(),'Написать заявление на выдачу дисконтной карты')]"); // Текст Написать заявление на выдачу дисконтной карты
    private By TextReceive = By.xpath("//*[contains(text(),'Получить дисконтную карту')]"); // Текст Получить дисконтную карту
    private By LabelBonus5 = By.xpath("//*[@src='/local/templates/invitro_main/src/image/icons/circle-5.svg']"); // Иконка бонус 5%
    private By LabelDK5pr = By.xpath("//div[@class='service-home-row on_discont']//img[@src='/local/templates/invitro_main/src/image/icons/5.svg']"); // Иконка ДК 5%
    private By LabelBonus7or10 = By.xpath("//img[@src='/local/templates/invitro_main/src/image/icons/circle-7-10.svg']"); // Иконка Бонус 7% или 10%
    private By LabelDK10pr = By.xpath("//div[@class='service-home-row on_discont']//img[@src='/local/templates/invitro_main/src/image/icons/10.svg']"); // Иконка ДК 10%

    //---Дисконтная программа «ИНВИТРО Здоровый плюс»
    private By HeadingDP = By.xpath("//h2[contains(text(),'Дисконтная программа «ИНВИТРО Здоровый плюс»')]"); // Заголовок Дисконтная программа

    //---О программе
    private By TextAboutThePprogram = By.xpath("//*[contains(text(),'О программе')]"); // Текст О программе
    private By TextDP = By.xpath("//div[contains(text(),'Получайте скидку по')]"); // Текст Получайте скидку по дисконтной карте, привязанной к карте Вашего контакта, или предъявляйте пластиковую дисконтную карту.

    //---Преимущества дисконтной программы
    private By HeadingPreimDP = By.xpath("//h2[contains(text(),'Преимущества дис')]"); // Заголовок Преимущества дисконтной программы
    private By Text1PreimDP = By.xpath("//li[contains(text(),'Номер дисконтной карты привязывается')]"); // Текст Номер дисконтной карты привязывается к карте контакта Пациента, не нужно носить с собой.
    private By Text2PreimDP = By.xpath("//li[contains(text(),'Дисконтную карту ИНВИТРО')]");// Текст Дисконтную карту ИНВИТРО можно передавать близким и друзьям. Скидка действует на предъявителя дисконтной карты.
    private By Text3PreimDP = By.xpath("//li[contains(text(),'Копите всей ')]"); //Текст Копите всей семьей, получайте скиду всей семьей.

    //---Как стать участником дисконтной программы?
    private By HeadingHowBecome = By.xpath("//h2[contains(text(),'Как стать участником дисконтной')]");//Как стать участником дисконтной программы?
    private By Text1HowBecome = By.xpath("//div[contains(text(),'Для того, чтобы получить')]");// Текст Для того, чтобы получить дисконтную карту ИНВИТРО необходимо:
    private By Text2HowBecome = By.xpath("//li[contains(text(),'Оформить и оплатить заказ ')]");// Текст Оформить и оплатить заказ в ИНВИТРО на сумму, достаточную для выдачи дисконтной карты,
    private By Text3HowBecome = By.xpath("//li[contains(text(),'Подписать согласие')]");// Текст Подписать согласие на участие в программе.

    //---Как воспользоваться дисконтной программой?
    private By HeadingHowTake = By.xpath("//h2[contains(text(),'Как воспользоваться ')]");// Заголовок Как воспользоваться дисконтной программой?
    private By Text1HowTake = By.xpath("//li[contains(text(),'Номер дисконтной карты «ИНВИТРО')]");// Текст Номер дисконтной карты «ИНВИТРО Здоровый плюс» (дисконтная карта нового образца) прикрепляется к Вашей карточке клиента, что позволяет Вам при повторном обращении в медицинский офис ИНВИТРО получить привилегию без предъявления пластиковой карты.
    private By Text2HowTake = By.xpath("//li[contains(text(),'Дисконтные карты, выданные ранее')]");// Текст Дисконтные карты, выданные ранее (дисконтные карты старого образца), также действуют в медицинских офисах ИНВИТРО, согласно правилам программы.
    private By Text3HowTake = By.xpath("//li[contains(text(),'Номер дисконтной карты старого')]");// Текст Номер дисконтной карты старого образца также может быть прикреплен к Вашей карточке контакта, что позволит Вам получать привилегию без предъявления пластиковой карты.
    private By Text4HowTake = By.xpath("//li[contains(text(),'Дисконтную карту старого образц')]");// Текст Дисконтную карту старого образца можно обменять на дисконтную карту нового образца.

    //---Типы дисконтных карт
    private By TextKindsPL = By.xpath("//*[contains(text(),'Типы дисконтных карт')]"); // Заголовок Виды дисконтных карт
    private By LabelDiscountDK5 = By.xpath("//*[@src='/upload/iblock/62c/62c21751338f1378c11771763c36545c.png']"); // Иконка Дисконтная карта номиналом 5%
    private By TextDiscountDK5 = By.xpath("//*[contains(text(),'Дисконтная карта номиналом 5%')]"); // Текст Дисконтная карта номиналом 5%
    ...
    private By TextIssuedInCases5 = By.xpath("//div[@class='description_discount']//*[contains(text(),'от 4 500 рублей')][1]"); // Текст Сумма единовременного заказа - от 4 500 рублей;
    private By TextIssuedInCases15 = By.xpath("//div[@class='description_discount']//*[contains(text(),'от 4 500 рублей')][2]"); // Текст Сумма всех заказов (суммарно, накопительным итогом) – от 4 500 рублей.

    private By NewLabelDiscountDK10 = By.xpath("//*[@class='loyalty__cart'][@src='/upload/iblock/aae/aae9a109b25caf7d63eeff4a4119ada1.png']"); // Иконка Дисконтная карта номиналом 10%
    private By TextDiscountDK10 = By.xpath("//*[contains(text(),'Дисконтная карта номиналом 10%')]"); // Текст Дисконтная карта номиналом 10%
    ...
    private By TextAbaDiscountDK1010 = By.xpath("//*[contains(text(),'от 15 000 рублей')][1]"); // Текст Сумма единовременного заказа - от 15 000 рублей;
    private By TextAbaDiscountDK210010 = By.xpath("//*[contains(text(),'от 15 000 рублей')][2]"); // Текст Сумма всех заказов (суммарно, накопительным итогом) – от 15 000 рублей;
    private By TextAbaDiscountDK310010 = By.xpath("//*[contains(text(),'превышает 10 000')]"); // Текст Если у вас есть дисконтная карта 5% и сумма дополнительных покупок превышает 10 000 рублей, вы можете получить карту номиналом 10% (карта 5% изымается).

    private By LabelDiscountDK13 = By.xpath("//*[@class='loyalty__cart'][@src='/upload/iblock/f88/f88b4ed6922691c35684771489c161c8.png']"); // Иконка Дисконтная карта номиналом 13%
    private By TextDiscountDK13 = By.xpath("//*[contains(text(),'Дисконтная карта номиналом 13%')]"); // Текст Дисконтная карта номиналом 13%
    private By TextIssuedInCases13 = By.xpath("//*[contains(text(),'Выдается бесплатно в')]"); // Текст Выдается бесплатно в медицинском офисе в индивидуальном порядке по решению компании.

    //---Также в медицинских офисах ИНВИТРО принимаются карты следующих образцов
    private By HeadingTakGe = By.xpath("//*[contains(text(),'Также в медицинских офисах')]"); // Текст Также в медицинских офисах ИНВИТРО принимаются карты следующих образцов
    private By LabelDiscountDKnom5 = By.xpath("//*[@src='/upload/iblock/d3f/d3f102be73eab63f93547a8922507311.png']"); //Иконка Дисконтная карта номиналом 5%
    private By LabelDiscountDKnom10 = By.xpath("//*[@src='/upload/iblock/763/76374112e888b47218c97b00cedcdfb5.png']"); //Иконка Дисконтная карта номиналом 10%
    private By LabelDK5p = By.xpath("//*[@src='/upload/iblock/70b/70b202ed665adae29113fb0101dc58b0.png']"); // Иконка Дисконтная карта номиналом 5% старого образца
    private By LabelDK10p = By.xpath("//*[@src='/upload/iblock/385/38553dc3ef07b95bb6703fd990f2a827.png']"); // Иконка Дисконтная карта номиналом 10% старого образца
    private By LabelDiscountDKnom13 = By.xpath("//*[@class='loyalty__cart'][@src='/upload/iblock/dbc/dbceedd789c102468de60a6232d63ad2.png']"); // Иконка Дисконтная карта номиналом 13%
    private By LabelDKKidzania = By.xpath("//*[@src='/upload/iblock/ada/ada716e89ad2dec9857ae6ea6e2a8876.png']"); // Иконка Дисконтная карта Кидзания

    private By TextDK5p = By.xpath("//div[@class = 'service-home-main__items'][1]/div[1]/span[contains(text(),'Дисконтная карта')]"); // Текст Дисконтная карта номиналом 5%
    private By TextDK10p = By.xpath("//div[@class = 'service-home-main__items'][1]/div[2]/span[contains(text(),'Дисконтная карта')]"); // Текст Дисконтная карта номиналом 10%
    private By TextDKold5p = By.xpath("//div[@class = 'service-home-main__items'][2]/div[1]/span[contains(text(),'Дисконтная карта')]"); // Текст Дисконтная карта номиналом 5% старого образца
    private By TextDKold10p = By.xpath("//div[@class = 'service-home-main__items'][2]/div[2]/span[contains(text(),'Дисконтная карта')]"); // Текст Дисконтная карта номиналом 10% старого образца
    private By TextDiscountDKnom13 = By.xpath("//div[@class = 'service-home-main__items'][3]/div[1]/span[contains(text(),'Дисконтная карта')]"); // Текст Дисконтная карта номиналом 13%
    private By TextDKKidzania = By.xpath("//*[contains(text(),'Кидзания')]"); // Текст Кидзания

    //---Переход на бонусную программу
    private By LabelGoToTheBonus = By.xpath("//h2[contains(text(),'Переход на бонусную программу')]"); // Заголовок Переход на бонусную программу
    private By TextWe = By.xpath("//*[contains(text(),'Вы можете стать уча')]"); // Текст Вы можете стать участником бонусной программы
    private By LabelDK5pp = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/5.svg']"); // Иконка Дисконтная карта номиналом 5% в блоке перехода
    private By LabelBonus7 = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/circle-7.svg']"); // Иконка Бонус 7%
    private By LabelaDK10pp = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/10.svg']"); // Иконка Дисконтная карта номиналом 10% в блоке перехода
    private By NewLabelBonus10 = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/circle-10.svg']"); // Иконка Бонус 10%
    private By NewLabelDK13pp = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/13.svg']"); // Иконка Дисконтная карта номиналом 13% в блоке перехода
    private By NewLabelBonus13 = By.xpath("//*[@class = 'service-home-row']//img[@src='/local/templates/invitro_main/src/image/icons/circle-13.svg']"); // Иконка Бонус 13%

    private By TextBonus5Kards = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[1]//div[1]//div[1]//span[1]"); //Дисконтная карта
    private By TextBonus7Kards = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[1]//div[1]//div[2]//span[1]"); // Текст Бонус 7%
    private By TextBonus10Kards = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[2]//div[1]//div[1]//span[1]"); //Дисконтная карта
    private By TextBonus10 = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[2]//div[1]//div[2]//span[1]"); // Текст Бонус 10%
    private By TextBonus13Kards = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[3]//div[1]//div[1]//span[1]"); //Дисконтная карта
    private By TextBonus13 = By.xpath("//body//div[@class='container-content show']//div[@class='container loyalty']//section[@class='content loyalty']//div[@class='service-home-row']//div[@class='service-home-column-main']//div[@class='service-home-column-main-wrap']//div[@class='service-home-column-main-wrap']/div[3]//div[1]//div[2]//span[1]"); // Текст Бонус 13%

    private By TextChange = By.xpath("//*[contains(text(),'Передумали?')]"); // Текст Передумали? В любой момент восстановите

    //---Правила программы
    private By HeadingRules = By.xpath("//*[contains(text(),'Правила')]"); // Заголовок Правила программы
    private By Rules3LoyaltyProgram = By.xpath("//*[@class = 'service-home-column-side']/following-sibling::div//*[contains(text(),'Полные правила программы')]"); // 3 Полные правила программы
